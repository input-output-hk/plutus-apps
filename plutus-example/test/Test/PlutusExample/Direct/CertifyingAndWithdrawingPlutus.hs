...
module Test.PlutusExample.Direct.CertifyingAndWithdrawingPlutus
...
hprop_plutus_certifying_withdrawing = H.integration . H.runFinallies . H.workspace "chairman" $ \tempAbsBasePath' -> do
  ...
  -- Plutus related
  plutusStakingScript <- H.note $ base </> "plutus-example/plutus/scripts/guess-42-stake.plutus"
  plutusStakingScriptRedeemer <- H.note $ base </> "plutus-example/plutus/data/42.redeemer"
