...
module Test.PlutusExample.Direct.TxInLockingPlutus
  ( prop_spending_plutus_script
  ) where
...
prop_spending_plutus_script :: Property
prop_spending_plutus_script = H.integration . H.runFinallies . H.workspace "chairman" $ \tempAbsBasePath' -> do
